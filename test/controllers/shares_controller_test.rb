...
class SharesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post shares_url, params: { share: { directory_id: @share.directory_id, filename: @share.filename, references: @share.references, server_id: @share.server_id, size: @share.size } }
    end
  ...
  test "should update share" do
    patch share_url(@share), params: { share: { directory_id: @share.directory_id, filename: @share.filename, references: @share.references, server_id: @share.server_id, size: @share.size } }
